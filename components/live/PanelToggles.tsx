...
const OPEN_PILL =
  "absolute z-20 inline-flex items-center gap-2 rounded-full border border-border bg-(--panel) backdrop-blur-md px-3 py-2 text-[11px] font-semibold uppercase tracking-wider text-foreground shadow-[0_12px_28px_rgba(0,0,0,0.5)] transition-colors hover:border-brand hover:text-brand focus-visible:outline-none min-h-[40px]";
