/**
 * ISO 3166-1 numeric → alpha-3 lookup table, used to match TopoJSON feature ids
 * to our normalized country records.
 *
 * Generated from the official ISO 3166-1 list. Covers all 249 assigned codes.
 */
...
export function numericToAlpha3(id: string | number | undefined | null): string | undefined {
  if (id == null) return undefined;
  const key = String(id).padStart(3, "0");
  return ISO_NUMERIC_TO_ALPHA3[key];
}
